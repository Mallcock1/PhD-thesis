...
\subsection{A brief history of solar magneto-seismology}

To motivate this chapter's focus on developing new temporal seismology techniques, we list a selection of the major advancements in SMS since its development.
...
\begin{table}
	...
	\begin{tabularx}{\linewidth}{l l X c}
		...
		1970 & \citeauthor{uch70} & Moreton wavefronts. & S \\
		1984 & \citeauthor{rob_etal84} & Introduced theory of coronal seismology. & T \\
		1995 & \citeauthor{tan95} & Prominence seismology. & T \\
	  	2001 & \citeauthor{nak_etal01} & Period of standing kink mode used to diagnose magnetic field strength. & T \\
    	2002 & \citeauthor{goo_etal02} & Damping time scales (assuming exponential damping) used to estimate density variation across loop. & T \\
 		2005 & \citeauthor{and_etal05} & Density stratification deduced from period ratio of first two standing kink harmonics. & T \\
 		2007 & \citeauthor{ver_etal07} & Anti-node shift due to density stratification along the loop. & S \\
 		2008 & \citeauthor{erd_etal08} & Sesimology of slow standing modes in coronal loops. & T \\
 		2013 & \citeauthor{pas_etal13} & Gaussian and exponential damping of kink modes to estimate loop density. & T \\
 		& \citeauthor{} & & \\
 		& \citeauthor{} & & \\
 		& \citeauthor{} & & \\
 		& \citeauthor{} & & \\
		...
		\bottomrule
	\end{tabularx}
	\caption{History of solar magneto-seismology development.}
...
\begin{itemize}
	...
	\item Magyar et al., 2017: Global dynamic coronal seismology - i.e. diagnosing the magnetic field strength changing in time and across a large portion of the corona. (Should also cite morton et al 2015 for method, and long et al 2017 for first dynamic seismology image.)
\end{itemize}
