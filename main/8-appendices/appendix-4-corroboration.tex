...
\section{Corroboration of the eigenfrequencies with an interface}\label{app: interface}
...
\section{Corroboration of the eigenfrequencies with a symmetric slab}\label{app: symmetric}
...
\section{Corroboration of the velocity solution with an interface}
...
\begin{cases}
(1 - e^{kx})\cos{kv_{A1}t} + e^{kx}\cos{kv_{AS}t} \quad &\text{ for } x \leq 0, \\
