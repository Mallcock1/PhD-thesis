...
\end{equation}
where
\begin{equation}f(x) = ik\left\{\rho_0\left[\dot{\hat{\Omega}}_0 - i\omega\hat{\Omega}_0\right] + \frac{d\rho_0}{dx}\left(\dot{\hat{v}}_{z0} - i\omega\hat{v}_{\textcolor{red}{z}0}\right)\right\}.
\end{equation}
...
In this section, we use the total pressure perturbation as our main variable. The velocity 




\color{red}
CONSIDER CHANGING TO VELOCITY VARIABLES. SHOULD BE POSSIBLE IN THEORY.
