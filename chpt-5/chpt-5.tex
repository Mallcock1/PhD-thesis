...
\newcommand{\figdir}{../main/figures/chpt-5/} % where figures are stored
...
\begin{figure}
	\centering
	\subfloat[Quasi-kink]{\includegraphics[width=0.5\textwidth]{\figdir slow-kink-surf_amp-ratio.pdf}
		\label{fig: AR slow kink surf}}
	\subfloat[Quasi-sausage]{\includegraphics[width=0.5\textwidth]{\figdir slow-saus-surf_amp-ratio.pdf}
		\label{fig: AR slow saus surf}}
	\\
	\subfloat[Quasi-kink]{\includegraphics[width=0.5\textwidth]{\figdir slow-kink-surf_min-pert-shift.pdf}
		\label{fig: MPS slow kink surf}}
	\subfloat[Quasi-sausage]{\includegraphics[width=0.5\textwidth]{\figdir slow-saus-surf_min-pert-shift.pdf}
...
\begin{figure}
	\centering
	\subfloat[Amplitude ratio inversion]{\includegraphics[scale=0.5]{\figdir RA_vA_approx_2var.pdf}
		\label{fig: RA vA approx}} \\
	\subfloat[Minimum perturbation shift inversion]{\includegraphics[scale=0.5]{\figdir DM_vA_approx_2var.pdf}
