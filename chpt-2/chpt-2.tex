...
\begin{figure}
	\centering
	\subfloat[$\rho_1/\rho_0=2$, $\rho_2/\rho_0=2$]{\includegraphics[width=0.5\textwidth]{\figdir Incomp_2_2.pdf}
		\label{fig: incomp22}}
	\subfloat[$\rho_1/\rho_0=10$, $\rho_2/\rho_0=2$]{\includegraphics[width=0.5\textwidth]{\figdir Incomp_10_2.pdf}
		\label{fig: incomp102}} \\
	\subfloat[$\rho_1/\rho_0=10$, $\rho_2/\rho_0=0.1$]{\includegraphics[width=0.5\textwidth]{\figdir Incomp_10_01.pdf}
		\label{fig: incomp1001}}
	\subfloat[$\rho_1/\rho_0=100$, $\rho_2/\rho_0=0.1$]{\includegraphics[width=0.5\textwidth]{\figdir Incomp_100_01.pdf}
...
\begin{figure}[]
	\centering
	\subfloat[$v_{A0} > c_0$]{\includegraphics[width=0.5\textwidth]{\figdir disp_sbs_R1-5.pdf}
		\label{fig: disp sbs}}
	\subfloat[$v_{A0} < c_0$]{\includegraphics[width=0.5\textwidth]{\figdir disp_sbb_R1-5.pdf}
		\label{fig: disp sbb}}
...
\begin{figure} []
	\centering
	\subfloat[]{\includegraphics[scale=0.55]{\figdir disp.pdf}
		\label{fig: disp avoided crossing}} \\
	
	\subfloat[]{\includegraphics[width=\textwidth]{\figdir xix_v2.pdf}
		\label{fig: xi}}
...
\appendix
\section{Eigenmodes of an asymmetric spring-mass oscillator} \label{app: coupled oscillator modes}
