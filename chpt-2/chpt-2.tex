...
\begin{figure}
	...
	\end{tikzpicture}
	\caption{The equilibrium state inside the slab, ($|x| \leq x_0$) and outside the slab, ($x < -x_0$ and $x > x_0$). The red arrows illustrate magnetic field lines, $B(x)\mathbf{\widehat{z}}$, and the dashed black lines indicate the boundaries of the slab. \textcolor{red}{Change to mag outside and correct parameter labelling}}
	\label{fig: eq}
\end{figure}
...
The main corollary to this result is that one can not conclude from an observation of a symmetric-looking MHD wave that the underlying waveguide is symmetric. This fallacy could lead to incorrect mode identification or diagnosis of the background plasma.
	...
	\makebox[\textwidth][c]{
		\subfloat[Quasi-symmetric quasi-sausage mode]{
			\begin{tikzpicture}[scale=\scale]
				...
				\draw [thick] (0,0.2) to [out=10, in=245] (2, 1.5) to [out=295, in=180] (4,0.1) to [out=0, in=260] (5,1.5) to [out=280, in=178] (6.2,0.04) to [out=358, in=180] (7,0.02);
		...
		\subfloat[Quasi-symmetric quasi-kink mode]{
			\begin{tikzpicture}[scale=\scale]
				...
				\draw [thick] (0,0.025) to [out=0, in=-178] (1.2, 0.05) to [out=2, in=260] (2,1.5) to [out=280, in=165] (3,0) to [out=-15, in=115] (5,-1.5) to [out=65, in=-170] (7,-0.2);
				\draw [->] (0,0) -- (0,2);
				\draw [->] (0,0) -- (7,0);
