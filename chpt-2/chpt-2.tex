...
\textcolor{red}{set up the general MHD wave eigenvalue problem?
The eigenvalue problem approach to MHD wave problems was first employed by \cite{alf42} to derive the theoretic existence of magnetically driven waves (now known as \textit{Alfv\'{e}n waves}) in fluids, the result that led to him being awarded the Nobel Prize in physics.
