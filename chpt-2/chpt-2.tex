...
\newcommand{\figdirII}{../main/figures/chpt-2/}
...
\input{../main/2-chpt/chpt-2.tex}

% include tex file for appendices
\appendix
\input{../main/8-appendices/appendix-1-spring-mass-oscillator.tex}
